...
const (
	defaultCollectors = "peerconnect"

//	defaultCollectors = "arp,conntrack,cpu,diskstats,entropy,edac,exec,filefd,filesystem,hwmon,infiniband,loadavg,mdadm,meminfo,netdev,netstat,peerconnect,sockstat,stat,textfile,time,uname,vmstat,wifi,xfs,zfs"
)
...
func main() {
	var (
		...
		listenAddress     = flag.String("web.listen-address", ":9009", "Address on which to expose metrics and web interface.")
